...
return array(
	 ...
	 */
	'groups' => array(
		-1   => array('name' => 'Zbanowany', 'roles' => array('banned')),
		 0   => array('name' => 'Gość', 'roles' => array()),
		 1   => array('name' => 'Użytkownik', 'roles' => array('user')),
		 2   => array('name' => 'Bibliotekarz', 'roles' => array('user', 'librarian')),
		 100 => array('name' => 'Administrator', 'roles' => array('user', 'librarian', 'admin'))
	),
